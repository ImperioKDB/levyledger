...
import DesktopProposalDetail from '@/components/DesktopProposalDetail'
    ...
    <>
      ...
      <div className="hidden xl:flex min-h-screen bg-ink">
        ...
        <div className="flex-1 flex flex-col">
          <DesktopTopBar universityName={uniSlug.toUpperCase()} />
          <DesktopProposalDetail id={id} proposal={proposal} treasury={treasury} loading={loading} />
        </div>
      </div>
    </>
  )
